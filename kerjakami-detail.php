...
<body class="bg-gray-200 overflow-x-hidden">
    ...
    <div class="pt-16 w-full md:w-11/12 lg:w-4/5 mx-auto">
        <div class="" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000">
            ...
            <?php } else { ?>
                <img class="object-cover h-96 w-full filter brightness-75 relative z-10 object-top" src="public/<?php echo $data["kategori"]; ?>/<?php echo $data["before_foto1"]; ?>" alt="image" />
            <?php } ?>
        </div>
