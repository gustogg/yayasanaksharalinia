                                        ...
                                        <?php } elseif ($row["jenis_file"] == "video") { ?>
                                            ...
                                            <?php if ($i % 2 == 1) { ?>
                                                ...
                                                <td class="w-2/12 text-left">
                                                    ...
                                                    <a href="publikasi-delete.php?hapus_data=<?php echo $row["id"]; ?>" name class="mt-3 flex flex-row bg-red-200 text-red-800 rounded-lg hover:bg-red-400 hover:text-red-900 px-6 py-3 w-max">
                                                        <button>
                                                            <i class="fas fa-trash-alt"></i>
                                                            Hapus
                                                        </button>
