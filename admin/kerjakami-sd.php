...
$kerjakami = query("SELECT * FROM kerjakami WHERE kategori = 'sd'");
?>

<?php include '../admin/layout/header.php'; ?>
<title>Kelola Data Kerja Kami - SD</title>
</head>
...
<body class="bg-gray-100 font-sans flex">
    ...
    <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text-black pb-3 font-bold">Kerja Kami - SD</h1>

            <div class="w-full mt-4">
                <div class="">
                    <a href="kerjakami-add.php?kategoriadd=sd" class="flex flex-row bg-blue-200 text-blue-800 hover:bg-blue-400 hover:text-blue-900 rounded-lg px-6 py-3 w-max">
                        <button>
